...
namespace Johnston_03_AnimationAndText.GameManagement
{
    public class GameManager
    {
        ...
        public Texture2D timSprites;
        public Texture2D someSprites;
        ...
        public void load(ContentManager aContentManager)
        {
            ...
            playBG = aContentManager.Load<Texture2D>("MarioBackground");
            timSprites = aContentManager.Load<Texture2D>("TimAnim");
            someSprites = aContentManager.Load<Texture2D>("SomeSprites");
